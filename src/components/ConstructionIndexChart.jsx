  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100">
      ...
      <p className="text-sm text-neutral-600 mb-2">
        Näitab ehitushinnaindeksi muutust kvartalite lõikes. Indeks arvutatakse võrreldes 1997. aastaga (1997=100) ning kajastab ehitustööde maksumuse muutust ajas. Allikas: Statistikaamet.
      </p>
